...
import { supabase, currentSession } from './supabase-client.js?v=20260511f';
import { toast } from './toast.js?v=20260511f';
import { openPlanModal, checkPaymentSuccess, fetchPlanInfo, PLANS } from './plan.js?v=20260511f';

// Bloque 5 (LCP): lazy import de los 11 módulos de vistas.
// Solo se descarga al navegar a esa vista. Reduce JS inicial ~50 KiB.
const VERSION = '?v=20260511f';
const VIEWS = {
